...
export const obterProjetosParaDistribuir = () => api.getRequest(HOST + '/avaliacao-resultados/projeto-inicio');
...
export const projetosPorEstado = (params) => {
    ...
    return api.getRequest(`${HOST}/avaliacao-resultados/fluxo-projeto${data}`);
};
